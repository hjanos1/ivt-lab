    ...
    public boolean fireTorpedos(FiringMode firingMode) {
        ...
        switch (firingMode) {
            ...
            case ALL:
                ...
                if (!primaryTorpedoStore.isEmpty()) {
                    boolean isPrimaryFiringSuccessfull = primaryTorpedoStore.fire(1);
                    firingSuccess = isPrimaryFiringSuccessfull;
                }
                if (!secondaryTorpedoStore.isEmpty()) {
                    boolean isSecondaryFiringSuccessfull = secondaryTorpedoStore.fire(1);
                    firingSuccess = firingSuccess || isSecondaryFiringSuccessfull;
                }
